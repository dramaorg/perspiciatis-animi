# @dramaorg/perspiciatis-animi

> forked from [@dramaorg/perspiciatis-animiode](https://www.npmjs.com/package/@dramaorg/perspiciatis-animiode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@dramaorg/perspiciatis-animiode/issues/300).

[![npm version](https://img.shields.io/npm/v/@dramaorg/perspiciatis-animi.svg)](https://www.npmjs.com/package/@dramaorg/perspiciatis-animi)
[![Downloads](https://img.shields.io/npm/dm/@dramaorg/perspiciatis-animi.svg)](https://www.npmjs.com/package/@dramaorg/perspiciatis-animi)
[![Build Status](https://github.com/dramaorg/perspiciatis-animi/workflows/CI/badge.svg)](https://github.com/dramaorg/perspiciatis-animi/actions)
...
```sh
npm install --save-dev eslint @dramaorg/perspiciatis-animi
```
...
```js
const nodePlugin = require("@dramaorg/perspiciatis-animi")
...
💼 [Configurations](https://github.com/dramaorg/perspiciatis-animi#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/dramaorg/perspiciatis-animi#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/dramaorg/perspiciatis-animi#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/dramaorg/perspiciatis-animi#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/dramaorg/perspiciatis-animi#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/dramaorg/perspiciatis-animi#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/dramaorg/perspiciatis-animi#-configs).\
...
`@dramaorg/perspiciatis-animi` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/dramaorg/perspiciatis-animi/releases)
